...
interface PostFormProps {
  ...
  previewUrl?: string; // Stateless preview link generated by server component
}

export function PostForm({ initialValues, previewUrl }: PostFormProps) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <div className="border border-neutral-200 dark:border-neutral-800 bg-neutral-50/40 dark:bg-zinc-950/20 rounded-xl p-5 space-y-5">
              ...
              {previewUrl && (
                <div className="bg-white dark:bg-zinc-900/50 border border-neutral-200/60 dark:border-zinc-800/80 rounded-xl p-4 space-y-3 shadow-xs animate-in fade-in slide-in-from-bottom-2 duration-300">
                  <div className="flex items-center justify-between text-xs">
                    <span className="font-bold uppercase tracking-wider text-neutral-500 dark:text-zinc-400">ตัวอย่าง (Preview)</span>
                    <span className="bg-amber-100 text-amber-800 dark:bg-amber-950/40 dark:text-amber-400 font-black px-2 py-0.5 rounded text-[10px] uppercase tracking-wider animate-pulse flex items-center gap-1 shrink-0">
                      <span className="w-1 h-1 rounded-full bg-amber-500 dark:bg-amber-400 animate-ping" />
                      <span>Unpublished</span>
                    </span>
                  </div>
                  <p className="text-[11px] text-zinc-500 dark:text-zinc-400 leading-normal">
                    แอดมินสามารถเปิดดูหน้าตาบทความจริงและตรวจทานความถูกต้องได้ก่อนการเผยแพร่:
                  </p>
                  <a
                    href={previewUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex w-full items-center justify-center gap-1.5 h-9 bg-neutral-900 hover:bg-neutral-800 text-white dark:bg-zinc-100 dark:hover:bg-zinc-200 dark:text-black text-xs font-bold rounded-lg shadow-xs transition-colors cursor-pointer"
                  >
                    <span>เปิดดูตัวอย่างหน้าเว็บ ↗</span>
                  </a>
                </div>
              )}
