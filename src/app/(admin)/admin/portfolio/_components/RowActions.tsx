...
import { deleteProjectAction } from "@/presentation/actions/portfolio.actions";
...
export function RowActions({ id, title }: RowActionsProps) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      >
        <Link href={`/admin/portfolio/${id}/edit`}>
      ...
      <AlertDialog>
        ...
        <AlertDialogContent className="bg-white dark:bg-zinc-950 border-neutral-200 dark:border-neutral-800">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              คุณต้องการลบผลงานเรื่อง &quot;{title}&quot; ใช่หรือไม่? การกระทำนี้ไม่สามารถย้อนกลับได้
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
